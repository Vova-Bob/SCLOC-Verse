...
# U+0456 (i) прибрано з класу \u0420 — легітимний український диграф «Рі»
# (Рішення, Рівень, Різний) давав false-positive. В mojibake після Р (CP1251 0xD0)
# іде продовження UTF-8 0x80-0xBF, а не U+0456 (D1 96) — прибрано без втрати покриття.
$pattern = "\u0420[\u00b0\u00b1\u0406\u0491\u00b5\u00b6\u00b7\u0451\u2116\u0454\u00bb\u0458\u0405\u0455\u0457]|\u0421[\u0403\u201a\u0453\u201e\u2026\u2020\u2021\u20ac\u2030\u2039\u040a\u040c\u040b\u040f\u2018]|\u00d0|\u00d1|\u00a0|\uFFFD|\?\?\?+"
